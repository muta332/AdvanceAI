...
#include "AdvanceAI/Public/Player/ABasePlayerCharacter.h"
...
void ABasePlayerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Completed, this, &ABasePlayerCharacter::MoveEnd);
...
void ABasePlayerCharacter::Move(const FInputActionValue& Value)
{
	...
	if (Controller != nullptr)
	{
		...
		{
			AnimPlaying = true;
			PlayMovementAnimation(true, MovementVector.Y, MovementVector.X);
		}
